...
pyinstaller --onefile --noconsole --clean --icon="soulsign.ico" --add-data "soulsign.ico;." --add-data "soulsign.png;." %ADD_BINARY% --name "SoulSign-Helper" soulsign_helper_gui.py
