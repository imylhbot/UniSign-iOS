...
pyinstaller --onefile --noconsole --clean --icon="soulsign.ico" --add-data "soulsign.ico;." --add-data "soulsign.png;." --add-data "unisign.ico;." --add-data "unisign.png;." %ADD_BINARY% --name "SoulSign-Helper" unisign_helper_gui.py
...
if %ERRORLEVEL% EQU 0 (
    ...
    copy /y "dist\SoulSign-Helper.exe" "..\package\UniSign-Helper.exe"
